...
**대상 영역**: `quality-director-dashboard` / Phase 2 고객 클레임 트래커  
...
- Git 상태 확인:
  - `quality-director-dashboard/QMS_2.0_MASTER_PLAN.md` 삭제 상태 감지
...
**위치**
- `quality-director-dashboard/QMS_2.0_MASTER_PLAN.md`
...
품질부문장 대시보드의 핵심 KPI가 실제 처리 성과와 다르게 표시된다. CEO 시연용 품질 대시보드에서 허위 또는 오인 가능한 지표가 될 수 있다.
...
1. `quality-director-dashboard/QMS_2.0_MASTER_PLAN.md` 삭제 상태 복구 또는 의도된 삭제 근거 승인.
